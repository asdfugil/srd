...
codesign --display --entitlements - --xml com.example.cryptex.dstroot/usr/bin/libclang_rt.ubsan_ios_dynamic.dylib > /private/tmp/dst-libclang_rt.ubsan_ios_dynamic.dylib.xml 
...
diff /private/tmp/src-nvram.xml diff /private/tmp/dst-nvram.xml
echo "Check for cryptex-run"
diff /private/tmp/src-cryptex-run.xml diff /private/tmp/dst-cryptex-run.xml
echo "Check for libclang_rt.ubsan_ios_dynamic.dylib"
diff /private/tmp/src-libclang_rt.ubsan_ios_dynamic.dylib.xml diff /private/tmp/dst-libclang_rt.ubsan_ios_dynamic.dylib.xml
